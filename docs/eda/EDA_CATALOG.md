...
- [Section 1: The "Top Charts" (Volume & Affinity Rankings)](#section-1-top-charts)
- [Section 2: Temporal & Behavioral Habits (Time-Series)](#section-2-temporal-habits)
- [Section 3: Engagement & Skip Behavior](#section-3-skip-behavior)
- [Section 4: Technical & Geographic Metrics](#section-4-technical-geographic)
- [Section 5: Niche & Advanced Behavioral Metrics](#section-5-niche-metrics)
...
### 1.2 Top N Artists by Year, Month & Season
...
### 1.3 All-Time & Periodic Top N Songs
...
### 1.4 The "Obsession" Metric (24-Hour Stream Velocity)
...
### 1.5 Top N Albums All-Time & Periodically
...
### 1.6 All-Time & Yearly Top N Genres (Linear Algebra Dot Product)
...
### 2.2 Day-of-Week Listening Distribution
...
### 2.3 Hour-of-Day Listening Distribution (24-Hour Circadian Rhythm)
...
### 2.5 Longest Consecutive Daily Listening Streak
...
### 3.2 Song Skip Rates (Repeat Skip Offenders)
...
### 3.3 Time-of-Day & Day-of-Week Skip Volatility
...
### 3.5 Lifecycle Transition Matrix (`reason_start` $\rightarrow$ `reason_end`)
...
### 4.2 Platform Engagement & Skip Ratios
...
### 4.3 Geographic Streaming Breakdown
...
### 4.4 Offline Playback Utilization
...
### 5.2 The "One-Hit Wonder" Wall of Fame
...
### 5.4 Session Binge Duration Distribution
